...
L.LLLLL.LL'''
    ...
    count_seats_full(input_seats_test)
    count_seats_full(input_seats_real)
...
def count_seats_full(raw_input: str):
    cleaned_seats = raw_input.split("\n")
    seats_dict = create_seats_dict(cleaned_seats)
    seats_dict_changed = check_all_seats(seats_dict)
    occupied_seats_current = 0
    occupied_seats_last = count_occupied_seats(seats_dict_changed)

    while occupied_seats_current != occupied_seats_last:
        occupied_seats_last = occupied_seats_current
        occupied_seats_current, seats_dict_changed = another_round(seats_dict_changed)
